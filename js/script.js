...
let api_url = `http://api.weatherapi.com/v1/forecast.json?key=7907aedd855a4a8f8bb51404221310&q=cairo&days=7`;
let date = new Date();
...
function show(data) {
  ...
  <div class="lower p-3 overflow-hidden">
    ...
    <img src="${data.current.condition.icon}" style = "width:70px"alt="" />
